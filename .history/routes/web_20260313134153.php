...
Route::middleware('checkLogin')->group(function(){
    ...
    Route::get('/suratkeluar', [SuratKeluarController::class, 'index'])->name('suratkeluar');
     Route::get('/suratkeluar/create', [SuratKeluarController::class, 'create'])->name('suratmasukCreate');
    Route::post('/suratkeluar/store', [SuratKeluarController::class, 'store'])->name('suratmasukStore');
    Route::get('/suratkeluar/edit/{id}', [SuratKeluarController::class, 'edit'])->name('suratmasukEdit');
    Route::post('/suratkeluar/update/{id}', [SuratKeluarController::class, 'update'])->name('suratmasukUpdate');
    Route::delete('/suratkeluar/destroy/{id}', [SuratKeluarController::class, 'destroy'])->name('suratmasukDestroy');

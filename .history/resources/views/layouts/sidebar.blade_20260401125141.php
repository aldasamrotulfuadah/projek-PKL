        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center" href="{{ route('home') }}" style="gap:4px; padding:0.75rem 1rem;">
        <img src="{{ asset('foto/logo1.png') }}" style="width:40px; height:auto;" alt="Logo">

            ...
            <form action="{{ route('suratmasukStore') }}" method="post">
                ...
                <div class="row mb-2">
                    <div class="col-xl-6 mb-2">
                        ...
                        <select name="Sifat" class="form-control @error('ifat') is-invalid @enderror">
                    ...
                    <div class="col-xl-6">
                        ...
                        <select name="Diteruskan_kepada" class="form-control @error('iteruskan_kepada') is-invalid @enderror">

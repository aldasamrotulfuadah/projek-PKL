            ...
            <form action="{{ route('suratmasukStore') }}" method="post">
                ...
                <div class="row mb-2">
                    <div class="col-xl-6">
                        ...
                        <input type="date" name="tanggal" class="form-control @error('tanggal_surat') is-invalid @enderror">
                        @error('tanggal_surat')
                    ...
                    <div class="col-xl-6">
                        ...
                        <input type="text" name="nomor" class="form-control @error('nomor_surat') is-invalid @enderror">
                        @error('nomor_surat')
                            <small class="text-danger">
                                {{ $message }}
                            </small>
                ...
                <div class="row mb-2">
                    <div class="col-xl-6">
                        ...
                        <input type="text" name="diterima_dari" class="form-control @error('diterima_dari') is-invalid @enderror">
                        @error('diterima_dari')
                            <small class="text-danger">
                                {{ $message }}
                            </small>
                ...
                <div class="row mb-2">
                    <div class="col-xl-12">
                        ...
                        <select name="Dengan_Hormat_Harap" class="form-control @error('dengan_hormat ') is-invalid @enderror">

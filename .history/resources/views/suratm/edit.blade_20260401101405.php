                ...
                <div class="row mb-2">
                    <div class="col-xl-12 mb-2">
                        ...
                        <select name="dengan_hormat_harap" class="form-control @error('dengan_hormat_harap') is-invalid @enderror">
                            ...
                            <option value="Proses Lebih Lanjut" {{                             <option value="Proses Lebih Lanjut" {{ $suratkeluar->dengan_hormat_harap == 'Proses Lebih Lanjut' ? 'selected' : ''}}>Proses lebih Lanjut</option>
->dengan_hormat_harap == 'Proses Lebih Lanjut' ? 'selected' : ''}}>Proses lebih Lanjut</option>

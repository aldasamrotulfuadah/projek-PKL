                ...
                <div class="row mb-2">
                    ...
                    <div class="col-xl-6">
                        ...
                        <select name="diteruskan_kepada" class="form-control @error('diteruskan_kepada') is-invalid @enderror">
                            ...
                            <option value="Kabid Ideologi Wawasan Kebangsaan, Ketahanan Eksosbud & Agama">Wasbang</option>
                            <option value="Kabid Kewaspadaan Nasional & Penanganan Konflik">Wasnas</option>

                ...
                <div class="row mb-2">
                    ...
                    <div class="col-xl-6">
                        ...
                        <select name="diteruskan_kepada" class="form-control @error('diteruskan_kepada') is-invalid @enderror">
                            ...
                            <option value="Wasbang" {{ $suratmasuk->diteruskan_kepada == 'Wasbang' ? 'selected' : ''}}>Wasbang</option>
                            <option value="Wasnas" {{ $suratmasuk->diteruskan_kepada == 'Wasnas' ? 'selected' : ''}}>Wasnas</option>
                            <option value="Poldagri" {{ $suratmasuk->diteruskan_kepada == 'Poldagri' ? 'selected' : ''}}>Poldagri</option>
                        </select> 
                ...
                <div class="row mb-2">
                    <div class="col-xl-12 mb-2">
                        ...
                        <select name="dengan_hormat_harap" class="form-control @error('dengan_hormat_harap') is-invalid @enderror">
                            ...
                            <option value="Koordinasi/Konsultasi" {{ $suratmasuk->dengan_hormat_harap == 'Tanggapan dan Saran' ? 'selected' : ''}}>Koordinasi/konsultasi</option>

...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('surat_masuks', function (Blueprint $table) {
            ...
            $table->enum('dengan_hormat_harap',['Tanggapan dan Saran','Proses Lebih Lanjut', 'Koordinasi/Konsultasi', 'Bahan Pertimbangan', 'Dibahas/Dikaji', 'Dibantu', 'Disiapkan Bahan', 'Mendampingi', 'Menghadiri', 'Mewakili']);

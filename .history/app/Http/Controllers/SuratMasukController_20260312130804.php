...
class SuratMasukController extends Controller
{
    ...
    public function store(Request $request){
        $request->validate([
            ...
            'nomor_surat'           => 'required|unique:suratmasuk,nomor_surat',
            ...
            'nomor_surat.required'    => 'Tanggal Surat Tidak Boleh Kosong',
            'nomor_surat.unique'    => 'Tanggal Surat Tidak Boleh Kosong',
            ...
            'diteruskan.required'    => 'Tanggal Surat Tidak Boleh Kosong',
            'tanggal_surat.required'    => 'Tanggal Surat Tidak Boleh Kosong',
        ]);
    }
